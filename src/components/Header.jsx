...
const Header = (props) => {
    ...
    return (
        <header
            className={`${fixed ? styles['fixed-header'] : undefined} ${
                mobile ? styles['fixed-header-transparent'] : undefined
            }`}>
            <div className={styles['header-wrapper']}>
                <div className={styles['common-block']}>
                    ...
                    <div className={styles['header-anchors']}>
                        <AnchorLink href="#secondBlock">Предложение</AnchorLink>
                        <AnchorLink href="#sixthBlock">Путь инвестора</AnchorLink>
                ...
                <div
                    className={`${styles['mobile-menu-button']} ${
                        mobile ? styles['menu-open'] : undefined
                    }`}
            ...
            <div
                className={`${styles['mobile-menu']} ${
                    mobile ? styles['mobile-menu-open'] : undefined
                }`}
                ...
                <AnchorLink
                    offset={150}
                    href="#fifthBlock"
                    className={styles['invest-button-mobile']}
                    onClick={() => setOpen(!mobile)}>
                    <Button>
                        <span>Инвестировать</span>
                    </Button>
