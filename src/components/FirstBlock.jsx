    ...
    return (
        ...
        >
            <div className={styles['inner-content']}>
                ...
                <h2>
                    Инвестиционная возможность<br />
                    прикоснуться к миру гейминга
                </h2>
                <h2 className={styles['mobile-view']}>
                    Игровая периферия <br /> от геймеров
                    для геймеров
                </h2>
                <p className={styles["mobile-text"]}>
                    Увеличим ваши инвестиции на 51,6% годовых за 12 месяцев, потому что мы создаем 
                    именно то, что покупают!
                </p>
                <div className={styles['list']}>
                    <div className={styles['listElement']}>
                        <div className={styles['listMark-circle']} />
                        <span>
                            Заключим договор займа до 51,6% годовых
                        </span>
                    </div>
                    <div className={styles['listElement']}>
                        <div className={styles['listMark-circle']} />
                    ...
                    <div className={styles['listElement']}>
                        <div className={styles['listMark-circle']} />
                        <span>
                            Продолжим наше взаимовыгодное сотрудничество
                        </span>
                    </div>
                </div>
            ...
            <div className={styles['section-bg']}>
                ...
                <div className={styles['bg-text-stripe']}>
                    <div className={styles['text-stripe']}>
                        {renderRunText(20)}
                    </div>
                </div>
            </div>
            <div className={styles['section-run-wrapper']}>
                <div className={styles['section-run-text']}>
                    {renderRunText(20)}
                </div>
            </div>
