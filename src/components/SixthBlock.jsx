                            ...
                            <div className={styles['slide-block']}>
                                ...
                                <div className={styles['slide-block-content']}>
                                    ...
                                    <div>
                                        <h5>Получить</h5>
                                        <span>
                                            Оплата основного долга и&nbsp;процентов производится
                                            каждые 7&nbsp;дней в&nbsp;течение всего срока договора.
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={styles['slide-block']}>
                                ...
                                <div className={styles['slide-block-content']}>
                                    ...
                                    <div>
                                        <h5>Продолжать</h5>
                                        <span>
                                            Мы&nbsp;растем, развиваемся и&nbsp;обеспечиваем
                                            стабильность дохода для инвесторов
                                        </span>
                                    </div>
                                </div>
                            </div>
