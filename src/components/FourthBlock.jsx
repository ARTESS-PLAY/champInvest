                        ...
                        <div className={styles['slideBlock']}>
                            ...
                            <div className={styles['slide-text']}>
                                ...
                                <span>
                                    ...
                                    огромное количество часов, как in-game, так и out-game. Игровой
                                    опыт вкупе со знаниями маркетинга помогает нам создавать
                                    качественные изделия, которыми мы пользуемся сами
                                </span>
                            </div>
                        </div>
                    </SwiperSlide>
                        ...
                        <div className={styles['slideBlock']}>
                            ...
                            <div className={styles['slide-text']}>
                                ...
                                <span>
                                    ...
                                    игроков из разных киберспортивных дисциплин, мы благодарны им, и
                                    делаем все возможное для роста в этом направлении
                                </span>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className={styles['slideBlock']}>
                            ...
                            <div className={styles['slide-text']}>
                                ...
                                <h5>Высокая маржа</h5>
                                <span>
                                    Напрямую работаем с фабриками Китая и России, что позволяет нам
                                    продавать товары с высокой маржинальностью до 70%
                                </span>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className={styles['slideBlock']}>
                            ...
                            <div className={styles['slide-text']}>
                                ...
                                <span>
                                    Мы не только создаем игровую периферию, а еще и учим людей
                                    играть в игры. Наша команда тренеров выступает в качестве
                                    наставников, предоставляя индивидуальные и групповые тренировки,
                                    а также помогают создавать контент: статьи, посты, фото и
                                    видеоматериалы
                                </span>
                            </div>
                        </div>
