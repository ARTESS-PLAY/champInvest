  ...
  "node_modules/animated-number-react/build/index.js"(exports, module) {
    !function(n, e) {
      ...
      return function(n2) {
        ...
        var u = t(3), i = t.n(u), c = t(4), f = t.n(c), s = t(9), l = t.n(s), p = function() {
          function n3(n4, e2) {
          ...
          function e2() {
            var n4, t2, o2, u2;
            r(this, e2);
            for (var i2 = arguments.length, c2 = Array(i2), f2 = 0; f2 < i2; f2++)
              c2[f2] = arguments[f2];
        ...
        !function(e2, r) {
          n2.exports = function() {
            function n3(n4, e4) {
              for (var t2 = n4.length, r3 = arguments.length >= 2 ? arguments[1] : void 0, a2 = [], o2 = 0; o2 < t2; o2 += 1)
                if (o2 in n4) {
                  var u2 = n4[o2];
            ...
            function o(n4, e4) {
              var t2 = a(n4);
              for (var r3 in n4)
                t2[r3] = e4.hasOwnProperty(r3) ? e4[r3] : n4[r3];
              return t2;
            }
            function u(n4, e4) {
              var t2 = a(n4);
              for (var r3 in e4)
                t2[r3] = T.und(n4[r3]) ? e4[r3] : n4[r3];
              return t2;
            }
            function i(n4, e4, t2) {
            ...
            function w() {
              ...
              function a2(n4) {
                ...
                if (n4 >= y2.currentTime)
                  for (var r4 = 0; r4 < t3; r4 += 1)
                    e5[r4].seek(n4);
                else
                  for (var a3 = t3; a3--; )
                    e5[a3].seek(n4);
              ...
              return y2.reset = function() {
                ...
                for (var t3 = y2.children.length; t3--; )
                  y2.children[t3].reset();
              }, y2.tick = function(n4) {
            ...
            var x = { update: void 0, begin: void 0, run: void 0, complete: void 0, loop: 1, direction: "normal", autoplay: true, offset: 0 }, P = { duration: 1e3, delay: 0, easing: "easeOutElastic", elasticity: 500, round: 0 }, T = { arr: function(n4) {
              ...
              function a2(n5, e5, t3, a3) {
                if (n5 >= 0 && n5 <= 1 && t3 >= 0 && t3 <= 1) {
                  ...
                  if (n5 !== e5 || t3 !== a3)
                    for (var c2 = 0; c2 < o2; c2 += 1)
                      i2[c2] = r3(c2 * u2, n5, t3);
                  return function(r4) {
